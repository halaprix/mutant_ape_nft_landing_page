        ...
        <>
            ...
            <section className='bg-primary-800 mt-28 md:mt-32 scroll-mt-28' id='team'>
                <div className='container'>
                    <h2 className='section_title'>Connect with our Team members and Founders:</h2>

                    <div className='grid grid-cols-2 gap-y-8 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-y-20'>
                        {teams.map((team, i) => (
                            <Team {...team} key={i} />
                        ))}
                    </div>
